# -*- coding: utf-8 -*-
"""Chapter12-CNN.ipynb
Hossein.Moharrer.Derakhshandeh
"""
...
import numpy as np
print('Predicted label for the first test sample: ', np.argmax(predictions[1]))
print('True label for the first test sample: ',test_labels[1])
